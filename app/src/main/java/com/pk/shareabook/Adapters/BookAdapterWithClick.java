...
/**
 * Created by AQSA SHaaPARR on 8/29/2017.
 */

public class BookAdapterWithClick extends RecyclerView.Adapter<BookAdapterWithClick.MyViewHolder> {
    ...
    public BookAdapterWithClick(List<HashMap<String, String>> mapList, Context context) {
